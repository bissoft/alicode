      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/banner/add')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Banner</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/salon/add')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Salon</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/salon/view')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Salon</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/freelancer/add')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Freelancer</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/freelancer/view')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/deal/add')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Deal</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/deal/view')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Deals</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/orders/view')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Orders</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{url('/page/add')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Add Page</p>
                    </a>
                  </li>
