            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td >
                        ...
                        <a class="btn btn-info btn-sm" href="{{url('/product/edit',$product->id)}}">
                        ...
                        <form id="delete-form-{{ $product->id }}" action="{{url('/product/delete',$product->id)}}" method="post"  style="display: none;">
                            @csrf()
                            @method('POST')
                          </form>
