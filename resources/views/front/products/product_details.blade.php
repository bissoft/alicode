                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-5">
                                        ...
                                        <div class="product-slider-single-nav normal-slider">
                                            @foreach ($product->images as $image)
                                            <div class="slider-nav-img"><img src="{{asset('uploads/products/'.$image->image)}}" alt="Product Image"></div>
                                            @endforeach
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="quantity">
                                                ...
                                                <div class="qty">
                                                    ...
                                                    <input type="number" value="1" name="quantity" style="width: 200px; background-color:#FF6F61;">
                                            ...
                                            <div class="p-size">
                                                ...
                                                <div class="btn-group btn-group-sm">
                                                    <select id= "selSize" name="size" class="selectpicker show-tick form-control">
                                                        <option value="{{$product->id}}-size">Size</option>
                                                    ...
                                                    <button type="button" value="{{$product->id}}-{{$sizes->size}}" class="btn">{{$sizes->size}}</button>
                                                    @endforeach --}}
                                            ...
                                            <div class="action">
                                                <input type="submit" class="btn fa fa-shopping-cart" name="" id="" value="Add to Cart">
